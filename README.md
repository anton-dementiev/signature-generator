...
- User-editable fields: `fullName`, `jobTitle`, `companyName`, `companyWebsiteUrl`, optional `websiteLabel`, `email`, optional `phone`, optional `linkedinUrl`, optional `tagline`, optional `calendarLabel`, optional `calendarUrl`.
- Global company settings: `companyName`, `companyWebsiteUrl`, optional `websiteLabel`, optional `tagline`, optional `calendarLabel`, optional `calendarUrl`, `logoUrl`, optional `bannerUrl`.

...
- User-editable fields: `fullName`, `jobTitle`, `companyName`, `companyWebsiteUrl`, `email`, optional `phone`, optional `linkedinUrl`, optional `tagline`, optional `calendarLabel`, optional `calendarUrl`, optional `includeConfidentiality`, optional `includeOptOut`.
- Global company settings: `companyName`, `companyWebsiteUrl`, optional `tagline`, optional `calendarLabel`, optional `calendarUrl`, optional `confidentialityText`, optional `optOutText`, `logoUrl`, optional `bannerUrl`.
